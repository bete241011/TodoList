...
//If there is any text inside the item field, add that text to the todo list when the Enter key pressed
...
function renderTodoList() {
  ...
  //console.log(data.todo.length, data.completed.length);
